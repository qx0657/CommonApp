package fun.qianxiao.commonapp.activity.opensourcelicense;
...
import fun.qianxiao.commonapp.activity.opensourcelicense.adapter.OpenSourceLicenseAdapter;
...
import fun.qianxiao.commonapp.databinding.ActivityOpensourcelicenseBinding;
